from flask import Blueprint,render_template,request,flash,redirect, current_app,abort,make_response \
    , url_for
...
from blueblog.forms  import CommentForm,AdminCommentForm
